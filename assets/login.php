...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="http://localhost:8000/newlogo.png">
  <title>
    Sales Pilot - Login
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="http://localhost:8000/assets/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
              <form action="http://localhost:8000/loginpage.php" method="post" role="form" class="text-start">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="http://localhost:8000/sign-up.php" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="http://localhost:8000/index.php" class="font-weight-bold text-white" target="_blank">Phemcode</a>
                for a better web.
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="http://localhost:8000/index.php" class="nav-link text-white" target="_blank">Phemcode</a>
                </li>
                <li class="nav-item">
                  <a href="http://localhost:8000/index.php" class="nav-link text-white" target="_blank">About Us</a>
                </li>
              </ul>
            </div>
          </div>
